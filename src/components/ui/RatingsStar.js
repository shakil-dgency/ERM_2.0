...
function Star({ fill = 0, idx = 0, size = 0, color = "#ff492c", empty = "#E5E7EB",idPrefix = ""  }) {
	...
	return (
		<div style={{ width: size, height: size, position: "relative", display: "inline-block" }}>
			...
			<svg viewBox="0 0 16 15" width={size} height={size} style={{ position: "absolute", left: 0, top: 0 }} className="h-[16px] w-[17px]" xmlns="http://www.w3.org/2000/svg">
			...
			<svg viewBox="0 0 16 15" width={size} height={size} className="h-[16px] w-[17px]" style={{ position: "absolute", left: 0, top: 0 }} xmlns="http://www.w3.org/2000/svg">
				<defs>
